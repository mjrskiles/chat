...
shell_command= 'py input-writer.py 0 2 client1-msgs.txt | java ChatClient 6001 >client1-recvd.txt 2>>client1-errors.txt &'
os.system( shell_command )

shell_command= 'py input-writer.py 1 2 client2-msgs.txt | java ChatClient 6001 >client2-recvd.txt 2>>client2-errors.txt'
os.system( shell_command )
...
shell_command= 'py input-writer.py 0 1 client1-msg.txt | java ChatClient 6001 >client1-recvd.txt 2>>client1-errors.txt &'
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client2-msg.txt | java ChatClient 6001 >client2-recvd.txt 2>>client2-errors.txt &'
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client3-msg.txt | java ChatClient 6001 >client3-recvd.txt 2>>client3-errors.txt'
os.system( shell_command )
...
shell_command= 'py input-writer.py 0 1 client1-msgs.txt | java ChatClient 6001 >client1-recvd.txt 2>>client1-errors.txt &'
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client2-msgs.txt | java ChatClient 6001 >client2-recvd.txt 2>>client2-errors.txt &'
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client3-msgs.txt | java ChatClient 6001 >client3-recvd.txt 2>>client3-errors.txt'
os.system( shell_command )
...
shell_command= 'py input-writer.py 0 1 client4-msgs.txt | java ChatClient 6001 >client4-recvd.txt 2>client4-errors.txt &'
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client5-msgs.txt | java ChatClient 6001 >client5-recvd.txt 2>client5-errors.txt &'
os.system( shell_command )

shell_command= 'py input-writer.py 0 1 client6-msgs.txt | java ChatClient 6001 >client6-recvd.txt 2>client6-errors.txt'
os.system( shell_command )
